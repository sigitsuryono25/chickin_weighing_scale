...
import 'partial/AppBar.dart';
import 'partial/TableHelper.dart';
                                    ...
                                    child: Obx(
                                      () => Switch(
                                          onChanged: (val) {
                                            ...
                                            tallyController.preferences.setBool(
                                                Constant.IS_AUTO_VALUE_BOBOT,
                                                tallyController.on.value);

                                            tallyController.preferences.getBool(
                                                Constant.IS_AUTO_VALUE_BOBOT);
                                          },
